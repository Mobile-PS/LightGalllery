...
class CustomRowComponent extends StatelessWidget {
  ...
  CustomRowComponent({required this.title, required this.tovalue, required this.status, required this.onpress, required this.mainindex, required this.subindex, required this.taskstatus, required this.loguserID, required this.assignID, required this.repeattype, required this.createdbyID, required this.byvalue});
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Text(
                loguserID == assignID && loguserID == createdbyID? 'Self': loguserID == createdbyID && loguserID != assignID?tovalue : loguserID != createdbyID && loguserID == assignID?byvalue:tovalue,
                overflow: TextOverflow.ellipsis,
