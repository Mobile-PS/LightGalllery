...
//  final con = Get.put(QuotesPageController());
  ...
  Future<void> getData() async {
    ...
    await apiHelper.post(
        api: "https://lightsgallery.in/apps/public/api/tasks",
        body: data,
        onSuccess: ({required response}) async {

          Map<String, dynamic> obj = jsonDecode(response.body);
          print(obj.toString());
          var successresp = TaskListModel.fromJson(obj);
                        ...
                        taskdata.length > 0?
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return TaskExpandedTile(
                                  userid: loguserId ?? 0,
                                  quotesResults: taskdata[index].tasks!,
                                  ...
                                  onpress1: (int mainindex,int subindex){
                                    ...
                                    Get.to(UpdateTaskscreen(tasks:taskdata[mainindex].tasks![subindex],maindate:taskdata[mainindex].date!))?.then((value) {
                                      getData();
