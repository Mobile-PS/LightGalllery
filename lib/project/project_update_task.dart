...
class ProjectUpdateTaskscreen extends StatefulWidget {
  final ProjectData tasks;
  final String maindate;

  const ProjectUpdateTaskscreen({super.key, required this.tasks, required this.maindate});

  @override
  _ProjectUpdateTaskscreen createState() => _ProjectUpdateTaskscreen();
}

class _ProjectUpdateTaskscreen extends State<ProjectUpdateTaskscreen> {
    ...
    await apiHelper.get(
        ...
        onSuccess: ({required response}) async {
          ...
          if (successresp.meta!.status! == "fail") {
            ...
            String date = widget.tasks.date.toString();
...
/*
  ...
  Future<void> updateTask() async {
    ...
    await apiHelper.post(
        api: "https://lightsgallery.in/apps/public/api/project-task/update/" +
  ...
  Future<void> updateStatus() async {
    ...
    await apiHelper.post(
        api:
            "https://lightsgallery.in/apps/public/api/project-task/status-update/" +
                widget.tasks.id.toString(),
        body: data,
        onSuccess: ({required response}) async {
          Map<String, dynamic> obj = jsonDecode(response.body);
  ...
  Future<void> deleteTask() async {
    ...
    ApiHelper apiHelper = ApiHelper();
    await apiHelper.get(
        api: "https://lightsgallery.in/apps/public/api/project-task/delete/" +
            widget.tasks.id.toString(),
        body: data,
        onSuccess: ({required response}) async {
          Map<String, dynamic> obj = jsonDecode(response.body);
