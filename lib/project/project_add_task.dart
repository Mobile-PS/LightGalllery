...
class ProjectAddTaskscreen extends StatefulWidget {
  final int projid;

  const ProjectAddTaskscreen({super.key, required this.projid});

  @override
  _ProjectAddTaskscreen createState() => _ProjectAddTaskscreen();
}

class _ProjectAddTaskscreen extends State<ProjectAddTaskscreen> {
//  final con = Get.put(QuotesPageController());
  ...
  Future<void> createTask() async {
    ...
    await apiHelper.post(
        api: "https://lightsgallery.in/apps/public/api/project-task/store",
        body: data,
        onSuccess: ({required response}) async {
